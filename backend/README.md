...
## Project Structure
    ...
    ├── testapiautoconnecto_72209  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_72209`
...
2. Clone this repo and `cd testapiautoconnecto_72209`
